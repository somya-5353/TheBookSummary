...
class Categories {
   ...
   static func getBooksForCategory(genre: GenresAvailable) -> [Categories] {
        ...
        if genre == .fiction {
            ...
            listOfBooks.append(Categories(title: "The Three Musketeers", coverImage: UIImage(named: "the-three-musketeers")!, author: "Alexander Dumas", summary: Summary.three))
            ...
            listOfBooks.append(Categories(title: "The History of Tom Jones", coverImage: UIImage(named: "tom")!, author: "Henry Fielding", summary: Summary.jones))
